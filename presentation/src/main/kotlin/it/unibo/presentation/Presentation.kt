...
interface Presentation {
    ...
    fun <T> registerDynamicSerializers(type: Class<T>, f: (Class<T>, ObjectMapper) -> Serializer<T>)
    fun <T> registerDynamicSerializers(type: Class<T>, types: EnumSet<MIMETypes>, f: (Class<T>, ObjectMapper) -> Serializer<T>)
    ...
    fun <T> registerDynamicDeserializers(type: Class<T>, f: (Class<T>, ObjectMapper) -> Deserializer<T>)
    fun <T> registerDynamicDeserializers(type: Class<T>, types: EnumSet<MIMETypes>, f: (Class<T>, ObjectMapper) -> Deserializer<T>)
